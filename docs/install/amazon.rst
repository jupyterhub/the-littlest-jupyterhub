...
#. On the page **Step 1: Choose an Amazon Machine Image (AMI)** you are going
   ...
   **||UBUNTU_PREVIOUS_VERSION|| (HVM), SSD Volume Type - ami-XXXXXXXXXXXXXXXXX** or (||UBUNTU_LATEST_VERSION||),
   leaving `64-bit (x86)` toggled.

   .. image:: ../images/providers/amazon/select_ubuntu_18.png
      :alt: Click ||UBUNTU_PREVIOUS_VERSION||
   ...
   **||UBUNTU_PREVIOUS_VERSION|| (HVM)** is the important part.
